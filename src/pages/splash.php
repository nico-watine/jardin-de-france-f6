...
og-image: https://jardindefrancetx.com/img/social-media/milieu/og-image.png
body-id: splash
body-class: splash
---
<section class="hero-splash grid-x grid-padding-x" id="welcome">
	...
	<div class="cell align-self-bottom" style="background: #fff;" data-sticky-container>
		<div class="row">

...
<section class="hero-splash grid-x show-for-large" id="welcome">
	...
	<div class="cell align-self-bottom" data-sticky-container>
		<div class="sticky desktop-nav-bar" data-sticky data-top-anchor="location" data-margin-top="0">
			<div class="row">
				...
				<ul class="menu align-right" data-animation-easing="swing" data-magellan data-offset="24">
					...
					<li><a href="#round-top">Round Top</a></li>
	...
	<div class="position-fixed-top">
		...
		<div class="top-bar align-right text-right" id="main-menu">
			...
			<ul class="menu vertical medium-horizontal" data-magellan data-animation-easing="swing">
				...
				<li><a class="magellan-link" href="#round-top">Round Top</a></li>
		...
		<div class="grid-x grid-padding-x">
			<div class="cell">
				<div class="prose-wrap">
					...
					<p class="p float-center">We will be in Round Top starting on October&nbsp;19 for the Fall Antique Festival. Come visit us at Excess&nbsp;Field&nbsp;2, Bader&nbsp;Ranch, and our newest location, The&nbsp;White&nbsp;Barn!</p>
				</div>

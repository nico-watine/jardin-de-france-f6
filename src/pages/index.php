			...
			<div class="cell">
				...
				<div class="vendor-logos">
					<div class="display-inline-block text-center logo-wrap" id="round-top-compound">
						<img class="display-block round-top-compound-logo" src="/img/vendors/The-Compound-Antique-Show-Logo-3.png" alt="The White Barn Logo" title="The White Barn Logo">
